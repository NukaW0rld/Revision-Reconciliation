...
plan: 06
subsystem: ui
tags: [pytest, htmx, review-workflow, docker, integration-tests, oob-swap]
...
tech-stack:
  ...
  patterns:
    ...
    - "Dual partial pattern for OOB-swappable UI sections: _foo.html for initial render (id only), _foo_oob.html for HTMX OOB (hx-swap-oob=outerHTML)"
